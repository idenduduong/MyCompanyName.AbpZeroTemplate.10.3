...
namespace MyCompanyName.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update MyCompanyNameDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update MyCompanyNameEfCoreEntityExtensionMappings to extend the IdentityUser entity

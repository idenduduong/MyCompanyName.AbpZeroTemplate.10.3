...
namespace MyCompanyName.Web.Menus
{
    public class MyCompanyNameMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public MyCompanyNameMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<MyCompanyNameResource>();

            context.Menu.Items.Insert(
                0,
                new ApplicationMenuItem(
                    MyCompanyNameMenus.Home,
                    l["Menu:Home"],
                    "~/",
                    icon: "fas fa-home",
                    order: 0

(function() {
    $(function() {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/DM_NhomDoiTuongs/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/DM_NhomDoiTuongs/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditDM_NhomDoiTuongsModal'
        });
        var _viewDM_NhomDoiTuongsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/DM_NhomDoiTuongs/ViewdM_NhomDoiTuongsModal',

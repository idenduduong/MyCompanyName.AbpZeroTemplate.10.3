(function($) {
    app.modals.CreateOrEditProductModal = function() {
        ...
        var _ProductuserLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/Products/UserLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Products/_ProductUserLookupTableModal.js',

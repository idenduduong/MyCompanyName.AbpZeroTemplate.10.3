(function($) {
    app.modals.CreateOrEditBaseEntityModal = function() {
        ...
        var _BaseEntityorganizationUnitLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/BaseEntities/OrganizationUnitLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/BaseEntities/_BaseEntityOrganizationUnitLookupTableModal.js',

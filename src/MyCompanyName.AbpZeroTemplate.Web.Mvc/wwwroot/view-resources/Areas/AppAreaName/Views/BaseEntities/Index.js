(function() {
    $(function() {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/BaseEntities/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/BaseEntities/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditBaseEntityModal'
        });
        var _viewBaseEntityModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/BaseEntities/ViewbaseEntityModal',
        ...
        _$baseEntitiesTable.on('click', '.Edit_Child_BaseEntityId', function() {
            ...
            var row = dataTable.row(tr);
            openDetailRow(this, "/AppAreaName/MasterDetailChild_BaseEntity_Childs?BaseEntityId=" + row.data().baseEntity.id);
        });
    });
})();
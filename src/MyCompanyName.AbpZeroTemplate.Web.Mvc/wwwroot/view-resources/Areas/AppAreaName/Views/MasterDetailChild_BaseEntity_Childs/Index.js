(function() {
    $(function() {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/MasterDetailChild_BaseEntity_Childs/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/MasterDetailChild_BaseEntity_Childs/_CreateOrEditModal.js',
            modalClass: 'MasterDetailChild_BaseEntity_CreateOrEditChildModal'
        });
        var _viewChildModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/MasterDetailChild_BaseEntity_Childs/ViewchildModal',

(function($) {
    app.modals.MasterDetailChild_BaseEntity_CreateOrEditChildModal = function() {
        ...
        var _ChilduserLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/MasterDetailChild_BaseEntity_Childs/UserLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/MasterDetailChild_BaseEntity_Childs/_ChildUserLookupTableModal.js',

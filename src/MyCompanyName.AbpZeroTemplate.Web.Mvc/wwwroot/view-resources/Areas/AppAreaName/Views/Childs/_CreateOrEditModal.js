(function($) {
    app.modals.CreateOrEditChildModal = function() {
        ...
        var _ChildbaseEntityLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/Childs/BaseEntityLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Childs/_ChildBaseEntityLookupTableModal.js',
            modalClass: 'BaseEntityLookupTableModal'
        });
        var _ChilduserLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/Childs/UserLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Childs/_ChildUserLookupTableModal.js',

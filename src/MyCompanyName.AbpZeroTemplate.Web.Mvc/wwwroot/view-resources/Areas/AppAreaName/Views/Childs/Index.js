(function() {
    $(function() {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/Childs/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Childs/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditChildModal'
        });
        var _viewChildModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/Childs/ViewchildModal',

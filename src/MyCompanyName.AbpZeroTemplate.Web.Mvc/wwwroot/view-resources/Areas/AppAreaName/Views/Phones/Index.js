    ...
    $(function () {
        ...
        var _permissions = {
         ...
         var _createOrEditModal = new app.ModalManager({
                    viewUrl: abp.appPath + 'AppAreaName/Phones/CreateOrEditModal',
                    scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Phones/_CreateOrEditModal.js',
                    modalClass: 'CreateOrEditPhoneModal'
                });
                   

		 var _viewPhoneModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/Phones/ViewphoneModal',

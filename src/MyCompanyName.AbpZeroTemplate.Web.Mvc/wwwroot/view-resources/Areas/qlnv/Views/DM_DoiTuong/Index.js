(function() {
    $(function() {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/DM_DoiTuong/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/DM_DoiTuong/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditDM_DoiTuongModal'
        });
        var _viewDM_DoiTuongModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/DM_DoiTuong/ViewdM_DoiTuongModal',

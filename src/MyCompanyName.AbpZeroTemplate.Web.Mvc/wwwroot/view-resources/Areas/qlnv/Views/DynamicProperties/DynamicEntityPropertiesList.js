(function () {
    $(function () {
        ...
        var _selectAnEntity = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/DynamicProperty/SelectAnEntityModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/DynamicProperties/_SelectAnEntityModal.js',
                    ...
                    },
                    {
                        ...
                        rowAction: {
                            element: $("<button/>")
                                ...
                                .click(function () {
                                    window.location.href = "/qlnv/DynamicEntityProperty/" + $(this).data().entityFullName;
                                })
                        }
                    },
                    {

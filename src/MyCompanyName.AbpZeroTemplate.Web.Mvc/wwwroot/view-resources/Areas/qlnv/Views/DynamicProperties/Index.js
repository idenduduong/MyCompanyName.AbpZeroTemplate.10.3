(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/DynamicProperty/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/DynamicProperties/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditDynamicPropertyModal',
            cssClass: 'scrollable-modal'
        });

        var _manageValuesModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/DynamicProperty/ManageValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/_Bundles/dynamic-properties-manage-values.min.js',

(function ($) {
    app.modals.UserDelegationsModal = function () {
        ...
        var _createNewUserDelegationModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Profile/CreateNewUserDelegationModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Profile/_CreateNewUserDelegationModal.js',

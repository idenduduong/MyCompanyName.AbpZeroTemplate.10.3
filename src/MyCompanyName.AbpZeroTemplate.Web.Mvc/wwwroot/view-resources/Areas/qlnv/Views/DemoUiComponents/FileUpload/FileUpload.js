$(function () {
    ...
    var url = abp.appPath + 'qlnv/DemoUiComponents/UploadFile';
    $('#fileupload').fileupload({
        ...
        dropZone: $('#fileuploadForm'),
            ...
            if (jsonResult.success) {
                var fileUrl = abp.appPath + 'qlnv/DemoUiComponents/GetFile?id=' + jsonResult.result.id + '&contentType=' + jsonResult.result.contentType;

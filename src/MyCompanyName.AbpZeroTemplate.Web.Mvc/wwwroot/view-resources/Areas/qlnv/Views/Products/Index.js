(function() {
    $(function() {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Products/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Products/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditProductModal'
        });
        var _viewProductModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Products/ViewproductModal',

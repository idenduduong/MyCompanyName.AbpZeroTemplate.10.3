(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Editions/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Editions/_CreateModal.js',
            modalClass: 'CreateEditionModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Editions/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Editions/_EditModal.js',
            modalClass: 'EditEditionModal'
        });

        var _moveTenantsToAnotherEditionModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Editions/MoveTenantsToAnotherEdition',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Editions/_MoveTenantsToAnotherEditionModal.js',

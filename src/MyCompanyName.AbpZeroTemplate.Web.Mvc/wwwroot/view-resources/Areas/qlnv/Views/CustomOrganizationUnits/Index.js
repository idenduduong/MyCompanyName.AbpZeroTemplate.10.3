(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/OrganizationUnits/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/OrganizationUnits/_CreateModal.js',
            modalClass: 'CreateOrganizationUnitModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/OrganizationUnits/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/OrganizationUnits/_EditModal.js',
            modalClass: 'EditOrganizationUnitModal'
        });

        var _addUserModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/OrganizationUnits/AddMemberModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/OrganizationUnits/_AddMemberModal.js',
        ...
        var _addRoleModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/OrganizationUnits/AddRoleModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/OrganizationUnits/_AddRoleModal.js',
        ...
        //  datdd:error when custom
        //var _entityTypeHistoryModal = app.modals.EntityTypeHistoryModal.create();

        function entityHistoryIsEnabled() {
            // datdd:disable EntityHistory
            return false;

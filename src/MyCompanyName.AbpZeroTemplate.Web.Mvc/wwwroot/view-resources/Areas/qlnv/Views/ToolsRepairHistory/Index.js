(function () {
    $(function () {
        ...
        var _$service = abp.services.app.toolsRepairHistory;
        ...
        var _createOrEditModal = new app.ModalManager({
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/ToolsRepairHistory/_CreateOrEditModal.js',
        ...
        var dataTable = _$entitiesTable.DataTable({
            ...
            columnDefs: [
                ...
                {
                    targets: 1,
                    data: "toolRepairHistory.posCode"
                },
                {
                    targets: 2,
                    data: "toolRepairHistory.posName"
                },
                {
                    targets: 3,
                    data: "toolRepairHistory.toolName"
                },
                {
                    targets: 4,
                    data: "type",
                ...
                {
                    targets: 7,
                    data: "toolRepairHistory.configuration"
                },
                {
                    targets: 8,
                    data: "toolRepairHistory.condition",
                    name: "condition",
                ...
                {
                    targets: 9,
                    data: "toolRepairHistory.toolStatus",
                    name: "status",
                ...
                {
					targets: 10,
                    data: "toolRepairHistory.repairFrom"
                },
                {
                    targets: 11,
                    data: "toolRepairHistory.repairTo"
                },
                {
                    targets: 12,
                    data: "toolRepairHistory.note"
                }
            ]
        });

(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + "qlnv/Tenants/CreateModal",
            scriptUrl: abp.appPath + "view-resources/Areas/qlnv/Views/Tenants/_CreateModal.js",
            modalClass: "CreateTenantModal"
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + "qlnv/Tenants/EditModal",
            scriptUrl: abp.appPath + "view-resources/Areas/qlnv/Views/Tenants/_EditModal.js",
            modalClass: "EditTenantModal"
        });

        var _featuresModal = new app.ModalManager({
            viewUrl: abp.appPath + "qlnv/Tenants/FeaturesModal",
            scriptUrl: abp.appPath + "view-resources/Areas/qlnv/Views/Tenants/_FeaturesModal.js",

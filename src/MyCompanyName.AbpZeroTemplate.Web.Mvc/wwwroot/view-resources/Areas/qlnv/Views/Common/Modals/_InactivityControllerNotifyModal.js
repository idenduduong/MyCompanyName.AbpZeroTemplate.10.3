(function () {
    ...
    app.modals.InactivityControllerNotifyModal.create = function () {
        var modal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Common/InactivityControllerNotifyModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Common/Modals/_InactivityControllerNotifyModal.js',

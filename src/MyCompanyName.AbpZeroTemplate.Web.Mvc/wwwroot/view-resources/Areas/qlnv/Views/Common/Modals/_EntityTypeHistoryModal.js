(function () {
    app.modals.EntityTypeHistoryModal = function () {
        ...
        function showEntityChangeDetails(entityChange) {
            var entityChangeDetailModal = new app.ModalManager({
                viewUrl: abp.appPath + 'qlnv/AuditLogs/EntityChangeDetailModal',
    ...
    app.modals.EntityTypeHistoryModal.create = function () {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Common/EntityTypeHistoryModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Common/Modals/_EntityTypeHistoryModal.js',

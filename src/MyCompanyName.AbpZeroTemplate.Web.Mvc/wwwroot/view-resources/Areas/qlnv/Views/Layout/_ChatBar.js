    ...
    getFormattedMessages: function (messages) {
        $.each(messages, function (index, message) {
            ...
            if (message.message.startsWith('[image]')) {
                ...
                var imageUrl = abp.appPath + 'qlnv/Chat/GetImage?id=' + message.id + '&contentType=' + image.contentType;
                ...
                var fileUrl = abp.appPath + 'qlnv/Chat/GetFile?id=' + message.id + '&contentType=' + file.contentType;
...
(function ($) {
    $(function () {
        ...
        var url = abp.appPath + 'qlnv/Chat/UploadFile';

(function ($) {
    $(function () {
        ...
        var mySettingsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Profile/MySettingsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Profile/_MySettingsModal.js',
        ...
        var changePasswordModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Profile/ChangePasswordModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Profile/_ChangePasswordModal.js',
        ...
        var changeProfilePictureModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Profile/ChangePictureModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Profile/_ChangePictureModal.js',
        ...
        var userLoginAttemptsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Users/LoginAttemptsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Users/_LoginAttemptsModal.js',
        ...
        var manageLinkedAccountsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Profile/LinkedAccountsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Profile/_LinkedAccountsModal.js',
        ...
        var userDelegationsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'qlnv/Profile/UserDelegationsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/qlnv/Views/Profile/_UserDelegationsModal.js',

$(function () {
    ...
    var url = abp.appPath + 'crm/DemoUiComponents/UploadFile';
    $('#fileupload').fileupload({
        ...
        maxFileSize: 999000,
            ...
            if (jsonResult.success) {
                var fileUrl = abp.appPath + 'crm/DemoUiComponents/GetFile?id=' + jsonResult.result.id + '&contentType=' + jsonResult.result.contentType;

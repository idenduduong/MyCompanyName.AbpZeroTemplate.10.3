(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'crm/OrganizationUnits/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/crm/Views/OrganizationUnits/_CreateModal.js',
            modalClass: 'CreateOrganizationUnitModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'crm/OrganizationUnits/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/crm/Views/OrganizationUnits/_EditModal.js',
            modalClass: 'EditOrganizationUnitModal'
        });

        var _addUserModal = new app.ModalManager({
            viewUrl: abp.appPath + 'crm/OrganizationUnits/AddMemberModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/crm/Views/OrganizationUnits/_AddMemberModal.js',
        ...
        var organizationTree = {
            ...
            generateTextOnTree: function (ou) {
                ...
                return '<span title="' + ou.code + '" class="ou-text' + itemClass + '" data-ou-id="' + ou.id + '">' + app.htmlUtils.htmlEncodeText(ou.displayName) + ' (<span class="ou-text-member-count">' + ou.memberCount + '</span>) &nbsp&nbsp<i style="font-size: 0.8rem" class="la la-angle-down text-muted"></i></span>';
            },
            ...
            init: function () {
                organizationTree.getTreeDataFromServer(function (treeData) {
                    ...
                    organizationTree.$tree.on('click', '.ou-text .la-angle-down', function (e) {
                        e.preventDefault();

...
(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + "crm/Tenants/CreateModal",
            scriptUrl: abp.appPath + "view-resources/Areas/crm/Views/Tenants/_CreateModal.js",
            modalClass: "CreateTenantModal"
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + "crm/Tenants/EditModal",
            scriptUrl: abp.appPath + "view-resources/Areas/crm/Views/Tenants/_EditModal.js",
            modalClass: "EditTenantModal"
        });

        var _featuresModal = new app.ModalManager({
            viewUrl: abp.appPath + "crm/Tenants/FeaturesModal",
            scriptUrl: abp.appPath + "view-resources/Areas/crm/Views/Tenants/_FeaturesModal.js",

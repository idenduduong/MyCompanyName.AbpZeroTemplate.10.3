(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'crm/Languages/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/crm/Views/Languages/_CreateOrEditModal.js',
            ...
            columnDefs: [
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                document.location.href = abp.appPath + "crm/Languages/Texts?languageName=" + data.record.name;
                            }
                        }, {

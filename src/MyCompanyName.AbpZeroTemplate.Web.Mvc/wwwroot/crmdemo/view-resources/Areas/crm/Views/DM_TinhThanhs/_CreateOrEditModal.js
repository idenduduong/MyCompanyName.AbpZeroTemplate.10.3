(function ($) {
	app.modals.CreateOrEditDM_TinhThanhModal = function () {
		...
		var _dM_QuocGiaLookupTableModal = new app.ModalManager({
			viewUrl: abp.appPath + 'qlnv/DM_TinhThanhs/DM_QuocGiaLookupTableModal',
			scriptUrl: abp.appPath + 'crmdemo/view-resources/Areas/crm/Views/DM_TinhThanhs/_DM_QuocGiaLookupTableModal.js',
			modalClass: 'DM_QuocGiaLookupTableModal'
		});

		var _dM_VungMienLookupTableModal = new app.ModalManager({
			viewUrl: abp.appPath + 'qlnv/DM_TinhThanhs/DM_VungMienLookupTableModal',
			scriptUrl: abp.appPath + 'crmdemo/view-resources/Areas/crm/Views/DM_TinhThanhs/_DM_VungMienLookupTableModal.js',

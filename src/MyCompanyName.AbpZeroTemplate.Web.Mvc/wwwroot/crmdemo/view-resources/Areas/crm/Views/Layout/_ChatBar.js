(function ($) {
    $(function () {
            ...
            getFormattedMessages: function (messages) {
                $.each(messages, function (index, message) {
                    ...
                    if (message.message.startsWith('[image]')) {
                        ...
                        var fileUrl = abp.appPath + 'crm/Chat/GetImage?id=' + message.id + '&contentType=' + image.contentType;
                        ...
                        var fileUrl = abp.appPath + 'crm/Chat/GetFile?id=' + message.id + '&contentType=' + file.contentType;
        ...
        var url = abp.appPath + 'crm/Chat/UploadFile';

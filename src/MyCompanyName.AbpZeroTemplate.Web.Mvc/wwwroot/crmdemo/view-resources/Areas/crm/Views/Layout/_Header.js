(function ($) {
    $(function () {
        ...
        var mySettingsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'crm/Profile/MySettingsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/crm/Views/Profile/_MySettingsModal.js',
        ...
        var changePasswordModal = new app.ModalManager({
            viewUrl: abp.appPath + 'crm/Profile/ChangePasswordModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/crm/Views/Profile/_ChangePasswordModal.js',
        ...
        var changeProfilePictureModal = new app.ModalManager({
            viewUrl: abp.appPath + 'crm/Profile/ChangePictureModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/crm/Views/Profile/_ChangePictureModal.js',
        ...
        var userLoginAttemptsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'crm/Users/LoginAttemptsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/crm/Views/Users/_LoginAttemptsModal.js',
        ...
        var manageLinkedAccountsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'crm/Profile/LinkedAccountsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/crm/Views/Profile/_LinkedAccountsModal.js',

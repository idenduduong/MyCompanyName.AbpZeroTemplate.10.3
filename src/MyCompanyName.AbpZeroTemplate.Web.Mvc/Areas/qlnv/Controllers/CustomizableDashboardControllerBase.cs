...
using MyCompanyName.AbpZeroTemplate.Web.Areas.qlnv.Models.CustomizableDashboard;
...
namespace MyCompanyName.AbpZeroTemplate.Web.Areas.qlnv.Controllers
{
    public abstract class CustomizableDashboardControllerBase : AbpZeroTemplateControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            ...
            return PartialView("~/Areas/qlnv/Views/Shared/Components/CustomizableDashboard/_AddWidgetModal.cshtml", viewModel);
        }

...
using MyCompanyName.AbpZeroTemplate.Web.Areas.qlnv.Models.DynamicEntityPropertyValues;
...
namespace MyCompanyName.AbpZeroTemplate.Web.Areas.qlnv.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : AbpZeroTemplateControllerBase
    {
        ...
        [HttpGet("/qlnv/DynamicEntityPropertyValue/ManageAll/{entityFullName}/{entityId}")]

...
using MyCompanyName.AbpZeroTemplate.Web.Areas.qlnv.Models.OrganizationUnits;
...
namespace MyCompanyName.AbpZeroTemplate.Web.Areas.qlnv.Controllers
{
    ...
    public class CustomOrganizationUnitsController : AbpZeroTemplateControllerBase
    {
        private readonly IRepository<OrganizationUnit, long> _organizationUnitRepository;

        public CustomOrganizationUnitsController(IRepository<OrganizationUnit, long> organizationUnitRepository)
        {

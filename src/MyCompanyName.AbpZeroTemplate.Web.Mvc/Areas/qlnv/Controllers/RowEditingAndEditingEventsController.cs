...
namespace MyCompanyName.AbpZeroTemplate.Web.Areas.qlnv.Controllers
{
    ...
    public class RowEditingAndEditingEventsController : AbpZeroTemplateControllerBase
    {
        private readonly IPhonesAppService _phonesAppService;

        public RowEditingAndEditingEventsController(IPhonesAppService phonesAppService)
        {

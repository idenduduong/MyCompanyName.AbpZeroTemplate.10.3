...
{
    public class qlnvMenuViewComponent : AbpZeroTemplateViewComponent
    {
        private readonly IUserNavigationManager _userNavigationManager;
        private readonly IAbpSession _abpSession;
        private readonly TenantManager _tenantManager;

        public qlnvMenuViewComponent(
        ...
        public async Task<IViewComponentResult> InvokeAsync(bool isLeftMenuUsed, string currentPageName = null)
        {
            ...
            {
                Menu = await _userNavigationManager.GetMenuAsync(qlnvNavigationProvider.MenuName, _abpSession.ToUserIdentifier()),
            ...
            var subscriptionManagement = FindMenuItemOrNull(model.Menu.Items, qlnvPageNames.Tenant.SubscriptionManagement);

...
namespace MyCompanyName.AbpZeroTemplate.Migrations
{
    ...
    [Migration("20211029013321_Add_Tool_History")]
    partial class Add_Tool_History
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.BDHN.ToolRepairHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BDHN_ToolRepairHistorys");
                });

            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.BDHN.ToolTransferHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FromPOSCode");

                    b.HasIndex("OrganizationUnitId");

                    b.HasIndex("ToPOSCode");

                    b.HasIndex("ToolId");

                    b.ToTable("BDHN_ToolTransferHistorys");
                });

            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.BDHN.Unit", b =>
                {
                    b.Property<string>("UnitCode")
                        .HasMaxLength(6)
                        .HasColumnType("nvarchar(6)");
                    ...
                    b.Property<string>("ParentUnitCode")
                        .HasMaxLength(6)
                        .HasColumnType("nvarchar(6)");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.BDHN.BuuCuc", b =>
                {
                    ...
                    b.HasOne("MyCompanyName.AbpZeroTemplate.BDHN.Unit", "UnitFk")
                        .WithMany()
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.BDHN.ToolRepairHistory", b =>
                {
                    ...
                    b.HasOne("MyCompanyName.AbpZeroTemplate.BDHN.Tool", "ToolFk")
                        .WithMany()
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.BDHN.ToolTransferHistory", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.BDHN.BuuCuc", "FromBuuCucFk")
                        .WithMany()
                        .HasForeignKey("FromPOSCode");

                    b.HasOne("Abp.Organizations.OrganizationUnit", "OrganizationUnitFk")
                        .WithMany()
                        .HasForeignKey("OrganizationUnitId");

                    b.HasOne("MyCompanyName.AbpZeroTemplate.BDHN.BuuCuc", "ToBuuCucFk")
                        .WithMany()
                        .HasForeignKey("ToPOSCode");

                    b.HasOne("MyCompanyName.AbpZeroTemplate.BDHN.Tool", "ToolFk")
                        .WithMany()
                        .HasForeignKey("ToolId");

                    b.Navigation("FromBuuCucFk");

                    b.Navigation("OrganizationUnitFk");

                    b.Navigation("ToBuuCucFk");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.BDHN.Unit", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.BDHN.Commune", "CommuneCodeFk")
                        .WithMany()
                        .HasForeignKey("CommuneCode");

...
namespace MyCompanyName.AbpZeroTemplate.crmdemo.Categories
{
    ...
    public class DM_DoiTuongsAppService : AbpZeroTemplateAppServiceBase, IDM_DoiTuongsAppService, IApplicationService, IEventHandler<OrganizationUnitUpdateEvent>, IEventHandler
    {
        ...
        public async Task<PagedResultDto<GetDM_DoiTuongForView>> GetAll(GetAllDM_DoiTuongsInput input)
        {
            ...
            IQueryable<GetDM_DoiTuongForView> query = (from o in filteredDM_DoiTuongs
                                                       ...
                                                       select new GetDM_DoiTuongForView
                                                       {
                                                           ...
                                                           DM_NhomDoiTuongTenNhom = ((s1 == null) ? string.Empty : s1.TenNhom.ToString()),
                                                           DM_TinhThanhTenTinhThanh = ((s2 == null) ? string.Empty : s2.TenTinhThanh.ToString()),
                                                           DM_QuanHuyenTenQuanHuyen = ((s3 == null) ? string.Empty : s3.TenQuanHuyen.ToString()),
                                                           UserName = ((s4 == null) ? string.Empty : s4.Name.ToString()),
                                                           NguonKhachHangTenNguonKhach = ((s5 == null) ? string.Empty : s5.TenNguonKhach.ToString()),
                                                           DM_TrangThaiTenTrangThai = ((s7 == null) ? string.Empty : s7.TenTrangThai.ToString()),
                                                           NguoiGioiThieu = ((s8 == null) ? string.Empty : s8.TenDoiTuong.ToString()),
                                                           DonViQuanLy = ((s9 == null) ? string.Empty : s9.DisplayName.ToString())
                                                       })
        ...
        public async Task<PagedResultDto<GetDM_DoiTuongForView2>> GetAllByDapper1(GetAllDM_DoiTuongsInput input)
        {
        ...
        public async Task<FileDto> GetDM_DoiTuongsToExcel(GetAllDM_DoiTuongsForExcelInput input)
        {
            ...
            List<GetDM_DoiTuongForView> dM_DoiTuongListDtos = await (from o in filteredDM_DoiTuongs
                                                                     ...
                                                                     select new GetDM_DoiTuongForView
                                                                     {
                                                                         ...
                                                                         DM_TinhThanhTenTinhThanh = ((s2 == null) ? string.Empty : s2.TenTinhThanh.ToString()),
                                                                         DM_QuanHuyenTenQuanHuyen = ((s3 == null) ? string.Empty : s3.TenQuanHuyen.ToString()),
                                                                         UserName = ((s4 == null) ? string.Empty : s4.FullName.ToString()),
                                                                         NguonKhachHangTenNguonKhach = ((s5 == null) ? string.Empty : s5.TenNguonKhach.ToString()),
                                                                         DM_TrangThaiTenTrangThai = ((s7 == null) ? string.Empty : s7.TenTrangThai.ToString()),
                                                                         NguoiGioiThieu = ((s8 == null) ? string.Empty : s8.TenDoiTuong.ToString()),
                                                                         DonViQuanLy = ((s9 == null) ? string.Empty : s9.DisplayName.ToString()),
                                                                         TenNguoiTao = ((s10 == null) ? string.Empty : s10.FullName.ToString()),
                                                                         TenNguoiSuaCuoi = ((s11 == null) ? string.Empty : s11.FullName.ToString()),
                                                                         NgheNghiepDisplayName = ((s12 == null) ? string.Empty : s12.DisplayName.ToString())

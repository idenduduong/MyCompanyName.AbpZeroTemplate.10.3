...
using MyCompanyName.AbpZeroTemplate.CustomUnits;

namespace MyCompanyName.AbpZeroTemplate.Organizations
{
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class CustomUnitAppService : AbpZeroTemplateAppServiceBase, IOrganizationUnitAppService
    {
        private readonly OrganizationUnitManager _organizationUnitManager;
        private readonly IRepository<OrganizationUnit, long> _organizationUnitRepository;
        private readonly IRepository<CustomUnit, long> _customUnitRepository;
        private readonly IRepository<UserOrganizationUnit, long> _userOrganizationUnitRepository;
        private readonly IRepository<OrganizationUnitRole, long> _organizationUnitRoleRepository;
        private readonly RoleManager _roleManager;

        public CustomUnitAppService(
            OrganizationUnitManager organizationUnitManager,
            IRepository<OrganizationUnit, long> organizationUnitRepository,
            IRepository<CustomUnit, long> customUnitRepository,
        ...
        {
            var customUnits = await _customUnitRepository.GetAllListAsync();
